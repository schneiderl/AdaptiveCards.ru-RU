...
### <a name="it-makes-tranmissions-over-the-wire-smaller"></a>Меньший объем передаваемых по сети данных
...
.NET | *Ожидается в ближайшее время* | *Ожидается в ближайшее время*
