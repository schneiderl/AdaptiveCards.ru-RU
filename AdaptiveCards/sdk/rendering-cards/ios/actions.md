...
---
# <a name="actions---ios"></a>Действия — iOS

Разработчики могут получать действия таких это операция SubmitAction и OpenUrl путем реализации ACRActionDelegate и задайте для него значение экземпляра AdaptiveCard.
