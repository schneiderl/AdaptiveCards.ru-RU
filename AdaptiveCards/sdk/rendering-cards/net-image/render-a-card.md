...
---
# <a name="render-a-card---net-image"></a><span data-ttu-id="bdda6-102">Подготовка изображения карты .NET</span><span class="sxs-lookup"><span data-stu-id="bdda6-102">Render a card - .NET Image</span></span>

<span data-ttu-id="bdda6-103">Ниже показано, как подготовить карту с помощью пакета SDK для образа .NET.</span><span class="sxs-lookup"><span data-stu-id="bdda6-103">Here's how to render a card using the .NET Image SDK.</span></span>
