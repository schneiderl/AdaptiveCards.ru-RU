...
1. Модуль подготовки отчетов **следует** позволяют размещать приложения знать, когда были загружены все образы HTTP и карточки «полностью обрабатывается»
...
1. Когда это **необходимо** вызвать пользователь касается действие, вызываемое событие.  
